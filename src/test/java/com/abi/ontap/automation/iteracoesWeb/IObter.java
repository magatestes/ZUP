...
public interface IObter extends IEncontraTipoElementoWeb {
	 ...
	 * @return String
	 */
	default String obterTexto(String elemento) {
		String retorno = null;
		try {
			logger.info(" -- Realizar acao de obter texto do elemento: " + elemento);
			retorno = encontra(elemento).getText();
	 ...
	 * @return String
	 */
	default String obterTexto(String propriedade, String elemento) {
		String retorno = null;
		try {
			logger.info(" -- Realizar acao de obter texto do elemento: " + elemento);
			retorno = encontra(propriedade, elemento).getText();
		} catch (NoSuchElementException e) {
			logger.warn(" -- Elemento: '" + elemento + "' NAO encontrado na plataforma: '"
					+ InteracaoSeleniumJavaWeb.nomePlataformaDeExecucao + "'.");
			Assert.fail(LocalDateTime.now() + " -- Teste falhado com o: '"
	 ...
	 * @return String
	 */
	default String obterTextoElemento(String propriedade, String elemento) {
		String retorno = null;
		try {
			logger.info(" -- Realizar acao de obter texto do elemento: " + elemento);
			retorno = encontra(propriedade, elemento).getText();
	 ...
	 * @return String
	 */
	default String obterValorCss(String elemento, String elementoCss) {
		String retorno = null;
		try {
			retorno = encontra(elemento).getCssValue(elementoCss);
		} catch (NoSuchElementException e) {
			logger.warn(" -- Elemento: '" + elemento + "' NAO encontrado na plataforma: '"
					+ InteracaoSeleniumJavaWeb.nomePlataformaDeExecucao + "'.");
			Assert.fail(LocalDateTime.now() + " -- Teste falhado com o: '"
	 ...
	 * @return String
	 */
	default String obterValorDoElementoAttribute(String elemento, String atributo) {
		String retorno = null;
		try {
			retorno = encontra(elemento).getAttribute(atributo);
		} catch (NoSuchElementException e) {
			logger.warn(" -- Elemento: '" + elemento + "' NAO encontrado na plataforma: '"
					+ InteracaoSeleniumJavaWeb.nomePlataformaDeExecucao + "'.");
			Assert.fail(LocalDateTime.now() + " -- Teste falhado com o: '"
	...
	public default String obterURLAtual() {
		try {
			System.out.println("Obtendo URL atual.. ");

			String url = DriverWeb.getDriver().getCurrentUrl();
			System.out.println("url obtida :" + url);
			return url;
		} catch (Exception e) {
			String valorError = "Não foi possivel obter URL";
